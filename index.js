...
let imagenes = []; // array para ORDENAR las imagenes recibidas del fetch
...
/*********************************/
//función para pintar en la página el tablero
  ...
  if (
    ...
    if (oJuego.aciertos * 2 == MAXIMO_FICHAS) {
      ...
      document.getElementById(
        "feedback"
      ).innerHTML = `<p>¡¡Enhorabuena!!</p><p>Estos son tus resultados:</p> <p>Número de intentos: ${
        oJuego.intentos
      }</p>
